<div class="card-dashboard mb-2">
    <div class="container-fluid">
        <div class="d-flex mb-2">
            <div class="logo">#</div>
            <span class="card-title">TOTAL VIEWS X IMPRESSIONS</span>
        </div>
        ...
        <div class="row mb-2">
            <div class="container">
                ...
                <div class="row tvi-infos">
                    ...
                    <div class="col-lg-1 d-flex justify-content-center tvi-country">
                        <img src="{{asset('img/flags/brasil.png')}}">
                        <span>BR</span>
                    </div>
                </div>

                <div class="tvi-chart-container">
